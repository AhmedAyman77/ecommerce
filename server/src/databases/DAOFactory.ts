...
import { SQLiteCloudConnection } from './connection/SQLiteCloudConnection';
...
export class DAOFactory {
    ...
    private constructor() {
        switch (databaseConfig.type) {
            ...
            case DatabaseType.sqliteCloud:
                this.connection = new SQLiteCloudConnection(databaseConfig.connectionString);
                break;
    ...
    public getUserDAO(): UserDAO {
        if (!this.userDAO) {
            if (databaseConfig.type === DatabaseType.sqlite || databaseConfig.type === DatabaseType.sqliteCloud) {
